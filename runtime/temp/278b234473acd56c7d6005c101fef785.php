<?php /*a:2:{s:80:"/Users/holy/Developer/ThinkPHP/mishop/application/index/view/address/manage.html";i:1588643202;s:76:"/Users/holy/Developer/ThinkPHP/mishop/application/index/view/Layout/app.html";i:1588394207;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="ui-card">
                <ul class="ui-card-item ui-list">
                    ...
                    <li class="ui-list-item identity">
                        <a href="javascript:;" data-id="<?php echo htmlentities($address->id); ?>" class="del_address">删除</a>
    ...
    $(function () {
        $('.del_address').click(function () {
            if(confirm('确定要删除么?')){
                ...
                $.ajax({
                    type: 'POST',
                    url: "/index/Address/delete/id/" + address_id,
                    success: function () {
