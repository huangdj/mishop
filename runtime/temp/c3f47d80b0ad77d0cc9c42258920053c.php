<?php /*a:5:{s:54:"/var/www/mishop/application/admin/view/menu/index.html";i:1588692257;s:54:"/var/www/mishop/application/admin/view/Layout/app.html";i:1587956237;s:65:"/var/www/mishop/application/admin/view/Layout/shared/_header.html";i:1587521497;s:66:"/var/www/mishop/application/admin/view/Layout/shared/_sidebar.html";i:1588335042;s:54:"/var/www/mishop/application/admin/view/menu/_form.html";i:1588365053;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="admin-content">
    ...
    <table class="am-table am-table-hover">
        ...
        <?php $__FOR_START_20613169__=0;$__FOR_END_20613169__=5;for($i=$__FOR_START_20613169__;$i < $__FOR_END_20613169__;$i+=1){ ?>
        <tr>
...
<div class="am-tab-panel am-fade" id="tab1">
    <table class="am-table am-table-hover">
        ...
        <?php $__FOR_START_500096898__=0;$__FOR_END_500096898__=5;for($i=$__FOR_START_500096898__;$i < $__FOR_END_500096898__;$i+=1){ ?>
        <tr>
            <td>二级菜单：<?php echo htmlentities($i+1); ?></td>
...
<div class="am-tab-panel am-fade" id="tab2">
    <table class="am-table am-table-hover">
        ...
        <?php $__FOR_START_1436371090__=0;$__FOR_END_1436371090__=5;for($i=$__FOR_START_1436371090__;$i < $__FOR_END_1436371090__;$i+=1){ ?>
        <tr>
            <td>二级菜单：<?php echo htmlentities($i+1); ?></td>
