<?php /*a:2:{s:80:"/Users/holy/Developer/ThinkPHP/mishop/application/index/view/Order/checkout.html";i:1588423444;s:76:"/Users/holy/Developer/ThinkPHP/mishop/application/index/view/Layout/app.html";i:1588394207;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="page-order-checkout">
        <div class="page-order-checkout-wrap">
            <div class="b1 icon_arrow" onclick="location.href='/index/Address/index'">
                ...
                <div class="b13"><p id="address" data-id="<?php echo htmlentities($address->id); ?>"><?php echo htmlentities($address->province); ?> <?php echo htmlentities($address->city); ?>
                    <?php echo htmlentities($address->area); ?> <?php echo htmlentities($address->detail); ?></p>
                </div>
                <?php else: ?>
