...
<div class="admin-content">
    <div class="admin-content-body">
        ...
        <div class="page-body">
            <form class="am-form am-form-horizontal" action="/admin/Product/update/id/<?php echo htmlentities($product->id); ?>" method="post">
                    ...
                    <div class="am-tabs-bd">
                        ...
                        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                                    ...
                                    <select multiple
                                        ...
                                        <optgroup label="<?php echo htmlentities($category->name); ?>">
                                            ...
                                            <option value="<?php echo htmlentities($child->id); ?>"
                                                    <?php if(is_array($product->categories) || $product->categories instanceof \think\Collection || $product->categories instanceof \think\Paginator): $i = 0; $__LIST__ = $product->categories;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(in_array(($child['id']), is_array($vo['id'])?$vo['id']:explode(',',$vo['id']))): ?>selected<?php endif; ?>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-12 am-u-md-5 am-u-end">
                                    <input type="text" name="name" value="<?php echo htmlentities($product->name); ?>">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-12 am-u-md-5 am-u-end">
                                    <select data-am-selected="{btnWidth: '100%', btnSize: 'sm', maxHeight: 360}"
                                        ...
                                        <option value="<?php echo htmlentities($brand['id']); ?>" <?php if($product->brand_id == $brand['id']): ?> selected <?php endif; ?>>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-12 am-u-md-5 am-u-end">
                                    <div class="am-form-group am-form-file">
                                        ...
                                        <input type="hidden" name="photo_id" value="<?php echo htmlentities($product->photo_id); ?>">
                                    </div>
                                    ...
                                    <div>
                                        <img src="<?php echo htmlentities($product->photo->image); ?>" id="img_show" style="max-height: 150px;margin-bottom: 10px;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-12 am-u-md-5 am-u-end">
                                    <input type="text" name="price" value="<?php echo htmlentities($product->price); ?>">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-12 am-u-md-5 am-u-end">
                                    <input type="text" name="stock" value="<?php echo htmlentities($product->stock); ?>">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-12 am-u-md-5 am-u-end">
                                    <input type="text" name="sort" value="<?php echo htmlentities($product->sort); ?>">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-12 am-u-md-5 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" value="1" name="is_onsale" <?php if($product->is_onsale == 1): ?> checked <?php endif; ?>> 是
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" value="0" name="is_onsale" <?php if($product->is_onsale == 0): ?> checked <?php endif; ?>> 否
                                    </label>
                                </div>
                            </div>
                                ...
                                <div class="am-u-sm-12 am-u-md-5 am-u-end">
                                    <div class="am-btn-group" data-am-button>
                                        <label class="am-btn am-btn-default am-btn-sm">
                                            <input type="checkbox" name="is_top" value="1" <?php if($product->is_top == 1): ?> checked <?php endif; ?>> 置顶
                                        </label>
                                        <label class="am-btn am-btn-default am-btn-sm">
                                            <input type="checkbox" name="is_recommend" value="1" <?php if($product->is_recommend == 1): ?> checked <?php endif; ?>> 推荐
                                        </label>
                                        <label class="am-btn am-btn-default am-btn-sm">
                                            <input type="checkbox" name="is_hot" value="1" <?php if($product->is_hot == 1): ?> checked <?php endif; ?>> 热销
                                        </label>
                                        <label class="am-btn am-btn-default am-btn-sm">
                                            <input type="checkbox" name="is_new" value="1" <?php if($product->is_new == 1): ?> checked <?php endif; ?>> 新品
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="am-tab-panel am-fade" id="tab2">
                            ...
                            <div class="am-margin-top">
                                ...
                                <div class="am-u-sm-12 am-u-md-5 am-u-end">
                                    <script id="container" name="content" type="text/plain"><?php echo htmlentities($product->content); ?></script>
                                </div>
                            </div>
                        </div>
                            ...
                            <ul data-am-widget="gallery"
                                ...
                                <li style="float: left;margin-left: 10px;">
                                    <div class="am-gallery-item">
                                        <a href="javascript:;">
                                            <img src="<?php echo htmlentities($gallery->img); ?>"/>
                                        </a>
                                        <div class="file-panel">
                                            <span class="cancel" data-id="<?php echo htmlentities($gallery->id); ?>">删除</span>
                                        </div>
                                    </div>
                                </li>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
