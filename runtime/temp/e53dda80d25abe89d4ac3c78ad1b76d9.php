<?php /*a:4:{s:79:"/Users/holy/Developer/ThinkPHP/mishop/application/admin/view/category/edit.html";i:1587711346;s:76:"/Users/holy/Developer/ThinkPHP/mishop/application/admin/view/Layout/app.html";i:1587956237;s:87:"/Users/holy/Developer/ThinkPHP/mishop/application/admin/view/Layout/shared/_header.html";i:1587521497;s:88:"/Users/holy/Developer/ThinkPHP/mishop/application/admin/view/Layout/shared/_sidebar.html";i:1587953255;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <ul class="am-list admin-sidebar-list">
            ...
            <li class="admin-parent">
                ...
                <ul class="am-list am-collapse admin-sidebar-sub <?php echo isset($_mishop) ? htmlentities($_mishop) : ''; ?>" id="collapse-mishop">
                    <li>
                        <a href="<?php echo url('/admin/Brand/index'); ?>" class="<?php echo isset($_brand) ? htmlentities($_brand) : ''; ?>">
                            商品品牌
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo url('/admin/Category/index'); ?>" class="<?php echo isset($_category) ? htmlentities($_category) : ''; ?>">
                            商品分类
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo url('/admin/Product/index'); ?>" class="<?php echo isset($_product) ? htmlentities($_product) : ''; ?>">
                            商品管理
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo url('/admin/Product/trash'); ?>" class="<?php echo isset($_trash) ? htmlentities($_trash) : ''; ?>">
                            商品回收站
                        </a>
                    </li>
                </ul>
