<?php /*a:2:{s:78:"/Users/holy/Developer/ThinkPHP/mishop/application/index/view/address/edit.html";i:1588642861;s:76:"/Users/holy/Developer/ThinkPHP/mishop/application/index/view/Layout/app.html";i:1588394207;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="edit-box">
            <ul class="ui-list">
                <li class="ui-list-item">
                    ...
                    <div class="ui-input"><input placeholder="真实姓名" name="name" maxlength="15" type="text" value="<?php echo htmlentities($address->name); ?>"></div>
                </li>
                <li class="ui-list-item">
                    <div class="label">手机号码：</div>
                    <div class="ui-input"><input placeholder="手机号" name="tel" maxlength="13" type="tel" value="<?php echo htmlentities($address->tel); ?>"></div>
                </li>
                <li class="ui-list-item">
                    <div class="label">所在地区：</div>
                    <div class="ui-input">
                        <input placeholder="省 市 区" name="pca" id="pca" maxlength="20" type="text" readonly="readonly"  value="<?php echo htmlentities($address->province); ?> <?php echo htmlentities($address->city); ?> <?php echo htmlentities($address->area); ?>">
                    </div>
                </li>
                <li class="ui-list-item">
                    <div class="label">街道地址：</div>
                    <div class="ui-input"><input placeholder="详细地址" name="detail" maxlength="120" type="text" value="<?php echo htmlentities($address->detail); ?>"></div>
                </li>
            </ul>
...
<script>
    $(function () {
        $('.save-button').click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "/index/Address/update/id/<?php echo htmlentities($address->id); ?>",
                data: data,
                success: function () {
                    location.href = "/index/Address/manage";
                }
            })
        })
    })
