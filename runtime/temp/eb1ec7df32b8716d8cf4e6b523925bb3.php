...
<div class="admin-content">
    <div class="admin-content-body">
        ...
        <div class="page-body">
            ...
            <form class="am-form am-form-horizontal" method="post" action="<?php echo url('admin/Brand/store'); ?>">
                <div class="am-form-group">
                    <label class="am-u-sm-12 am-u-md-3 am-form-label">名称</label>
                    <div class="am-u-sm-12 am-u-md-5 am-u-end">
                        <input type="text" name="name" placeholder="输入品牌名称">
                    </div>
                </div>
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-12 am-u-md-5 am-u-end">
                        <textarea rows="8" placeholder="请输入描述信息" name="description"></textarea>
                    </div>
                </div>
